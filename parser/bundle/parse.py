...
# Constants
GENUS_SPECIES_PATH = "missing.json"
...
def sparql_query(scientific_name):
    ...
    def get_qid(name):
        ...
        """
        qid_resp = requests.get(SPARQL_ENDPOINT, params={"query": qid_query, "format": "json"}, headers={"User-Agent": USER_AGENT})
    ...
    resp = requests.get(SPARQL_ENDPOINT, params={"query": query, "format": "json"}, headers={"User-Agent": USER_AGENT})
